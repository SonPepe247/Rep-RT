  ...
  <div class="row g-0">
    ...
    <div class="col-md-6">
      <div class="card-body">
        ...
        <p class="card-text"><strong style="color:#02245b;font-size:17px;">1. Protección contra Robos e Intrusiones mediante Sistemas de Alarma:</strong>
        Los sistemas de alarma representan una medida efectiva para disuadir intrusiones no autorizadas. Cuando se activa una alarma, se activan sirenas o se envían notificaciones a las autoridades, lo que puede prevenir robos y daños a la propiedad. Ayudando a su vez a minimizar las pérdidas asociadas a estos eventos.
<br><br>
        <strong style="color:#02245b;font-size:17px;">2.Detectar rápidamente:</strong> robos, incendios u otras emergencias, los sistemas de alarma pueden ayudar a minimizar las pérdidas económicas asociadas con estos eventos. <br><br>
        <strong style="color:#02245b;font-size:17px;">3. Notificaciones y Alertas Personalizables en Sistemas de Alarma:</strong>
        Los sistemas de alarma ofrecen la posibilidad de personalizar notificaciones y alertas, permitiendo a los usuarios recibir información específica sobre eventos que ocurran.</p>
